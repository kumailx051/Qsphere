  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={infoStyle}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={palette.accentPrimary} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
          ...
          {NAV_LINKS.map((lnk, i) => (
            <span key={lnk.to} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <Link
                ...
                onMouseEnter={e => (e.target.style.color = palette.accentPrimary)}
                onMouseLeave={e => (e.target.style.color = palette.textSecondary)}
              >
                {lnk.label}
              </Link>
      ...
      <div
        style={{
          height: 1,
          background: `linear-gradient(90deg,transparent,${palette.accentBorder},transparent)`,
          marginBottom: 28,
        }}
      />
